# Community extension logo sources

These images are local copies of the icon URLs declared by the reviewed extension manifests in
the `tome-io/extensions` repository:
